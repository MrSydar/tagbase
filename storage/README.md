...
- `timeout_ms`: query timeout in milliseconds. Defaults to `30000` (30s), clamped to a hard minimum of `1000` (1s) and maximum of `300000` (5m). If reached and `best_effort` is `false`, a `query_timeout` error is returned.
